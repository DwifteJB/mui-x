...
module.exports = {
  ...
  overrides: [
    ...
    buildPackageRestrictedImports('@dwifte/x-charts', 'x-charts'),
    buildPackageRestrictedImports('@dwifte/x-data-grid', 'x-data-grid'),
    ...
    buildPackageRestrictedImports('@dwifte/x-pickers', 'x-pickers'),
    buildPackageRestrictedImports('@mui/x-pickers-pro', 'x-pickers-pro'),
    buildPackageRestrictedImports('@dwifte/x-tree-view', 'x-tree-view'),
