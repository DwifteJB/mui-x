...
const defaultAlias = {
  '@dwifte/x-data-grid': resolveAliasPath('./packages/x-data-grid/src'),
  '@dwifte/x-data-grid-generator': resolveAliasPath('./packages/x-data-grid-generator/src'),
  ...
  '@dwifte/x-date-pickers': resolveAliasPath('./packages/x-date-pickers/src'),
  '@mui/x-date-pickers-pro': resolveAliasPath('./packages/x-date-pickers-pro/src'),
  '@dwifte/x-charts': resolveAliasPath('./packages/x-charts/src'),
  '@dwifte/x-tree-view': resolveAliasPath('./packages/x-tree-view/src'),
  '@dwifte/x-tree-view-pro': resolveAliasPath('./packages/x-tree-view-pro/src'),
  '@dwifte/material-nextjs': '@mui/monorepo/packages/mui-material-nextjs/src',
