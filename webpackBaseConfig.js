...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@dwifte/x-data-grid': path.resolve(__dirname, './packages/x-data-grid/src'),
      '@dwifte/x-data-grid-generator': path.resolve(__dirname, './packages/x-data-grid-generator/src'),
      ...
      '@dwifte/x-date-pickers': path.resolve(__dirname, './packages/x-date-pickers/src'),
      '@mui/x-date-pickers-pro': path.resolve(__dirname, './packages/x-date-pickers-pro/src'),
      '@dwifte/x-charts': path.resolve(__dirname, './packages/x-charts/src'),
      '@dwifte/x-tree-view': path.resolve(__dirname, './packages/x-tree-view/src'),
      '@dwifte/x-tree-view-pro': path.resolve(__dirname, './packages/x-tree-view-pro/src'),
